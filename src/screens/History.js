    ...
    <SafeAreaView style={{flex:1, margin: 20, marginBottom: 70}}>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        {buttons.map((data, index) => {
          return (
            <TouchableOpacity  key={index} style={{borderRadius: 10, borderColor: '#6C5DD2', borderWidth: 1, backgroundColor: data.isClicked? '#6C5DD2' : '#FFFFFF', paddingVertical: 6, paddingHorizontal: 3, marginRight: 5}} onPress={() => toggleButton(index)}>
