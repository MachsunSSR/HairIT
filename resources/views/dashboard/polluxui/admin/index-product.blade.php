...
<div class="col-12 grid-margin stretch-card">
  <div class="card">
      <div class="card-body justify-content-center">
        ...
        <div class="tomboladd">
          <a href="{{ route('layanan.create') }}" type="submit" class="btn btn-primary">Tambah Product</a>
        </div>
        </div>
      </div>
  </div>
              ...
              <tr>
                  ...
                  <td>
                      <form action="{{ url('layanan',$item->id) }}" method="POST">
                          @csrf
                          @method('delete')
                          <a href="{{ route('layanan.show',$item->id) }}" type="submit" class="btn btn-info btn-sm mx-2">Detail Product</a>
                          <a href="{{ route('layanan.edit',$item->id) }}" type="submit" class="btn btn-warning btn-sm mx-2">Edit Product</a>
